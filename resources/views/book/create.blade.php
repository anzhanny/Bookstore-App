  ...
  <div id="app">
    <div class="main-wrapper main-wrapper-1">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <form action="book/store/" method="post" class="form-inline mr-auto">
          ...
          <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="#">Book Store</a></div>
              <div class="breadcrumb-item"><a href="#">Data Book</a></div>
                <div class="breadcrumb-item">Add Data Book</div>
        </div>
            </div>
            <h2 class="section-title">Data Book</h2>
                ...
                <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-12">
                        ...
                        <button class="btn btn-secoundary" a href="/book">back</button>
                      </div>
                      <div >
